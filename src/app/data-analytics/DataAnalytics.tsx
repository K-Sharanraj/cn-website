    ...
    const projects = [
        {
            ...
            image: "https://res.cloudinary.com/dn60aovto/image/upload/v1742471352/1_jgxwrh.webp",
            icon: <MonitorPlay className="w-5 h-5" />
        },
        {
            title: "Stock Market Prediction",
            type: "Data Analyst Project",
            image: "https://res.cloudinary.com/dn60aovto/image/upload/v1742471572/2_upm4il.jpg",
            icon: <MonitorPlay className="w-5 h-5" />
        },
        {
            title: "Sales & Revenue Forecasting",
            type: "Data Analyst Project",
            image: "https://res.cloudinary.com/dn60aovto/image/upload/v1742471353/4_txvsra.jpg",
            icon: <MonitorPlay className="w-5 h-5" />
        },
        {
